...
It should build on most modernish Unix-style systems:
 ...
 - Command line options may not work properly due to differences in how `getopt(3)` is reset.  Adjust `getopt_reset()` in make_m2.h for your platform, if necessary.
