...
#define BIT_SUFFIX_INFERENCE 4
#if defined(__CYGWIN__)
#define BIT_WINDOWS 5
#define BIT_POSIX_2017 6
#define BIT_POSIX_2024 7
#define BIT_POSIX_202X 8
...
#define P_SUFFIX_INFERENCE (1 << BIT_SUFFIX_INFERENCE)
