...
OBJS = check.o extensions.o input.o macro.o main.o make.o modtime.o options.o read.o rules.o runtime.o startup.o target.o utils.o
M2_CC = ../stage0-posix/AMD64/bin/M2-Mesoplanet
M2_BINDIR = ../stage0-posix/AMD64/bin
M2LIBC_PATH = ../stage0-posix/M2-Mesoplanet/M2libc
M2_OBJS = check.m2.o macro.m2.o main.m2.o make.m2.o modtime.m2.o options.m2.o rules.m2.o runtime.m2.o startup.m2.o target.m2.o utils.m2.o
...
$(OBJS): make.h
check.o: make_m2.h
input.o: input_expand.inc input_condition.inc input_classify.inc input_command.inc
macro.o: make_m2.h
main.o: make_m2.h
make.o: make_m2.h
modtime.o: make_m2.h
