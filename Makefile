...
OBJS = check.o command.o extensions.o input.o macro.o main.o make.o modtime.o options.o read.o rules.o runtime.o startup.o target.o utils.o
...
$(OBJS): make.h
check.o: make_m2.h
input.o: input_expand.inc input_condition.inc input_classify.inc
macro.o: make_m2.h
main.o: make_m2.h
make.o: make_m2.h
modtime.o: make_m2.h
